/Extract the information about all department managers who were hired between the 1st of January 1990 and the 1st of January 1995./Add commentMore actions
SELECT *
FROM dept_manager
WHERE emp_no IN (
